...
import CreateJobApplicationDialog from "./job-dialog";
...
import { deleteAllJobsInColumn } from "@/lib/action/job-app";
...
function DroppableColumn({column, boardId, config, sortedColumns}:
    {
        column: Column;
        config: ColConfig;
        boardId: string;
      ...
      async function handleDeleteAllJobs() {
        try {
          const result = await deleteAllJobsInColumn(column._id);
              ...
              <div className="flex items-center justify-between">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem className="text-destructive" onClick={handleDeleteAllJobs}>
