      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 py-32">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-black mb-6 text-6xl front-bold">
              Track Every Opportunity.
              Land Your Dream Job.
            </h1>
            <p className="text-muted-foreground mb-10 text-xl">
              A clean and powerful job application tracker that helps you organize applications, monitor interview stages, and manage your entire job search from one place.
            </p>
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-sm text-muted-foreground">Free to use. No subscriptions. No credit card required.</p>
            </div>
          </div>
        </section>
        <ImageTabs/>
